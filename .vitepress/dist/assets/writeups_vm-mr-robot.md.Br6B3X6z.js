import{_ as n,c as a,af as e,o as p}from"./chunks/framework.DkzxBdcE.js";const h=JSON.parse(`{"title":"VM - Mr Robot","description":"La série Mr Robot est un peu comme la série que l'on attendais tous, celle ou on peut parler d'informatique sans forcement tomber dans les clichés. Le site vulnhub propose un challenge autour du thème de cette série. En voici le writeup","frontmatter":{"title":"VM - Mr Robot","description":"La série Mr Robot est un peu comme la série que l'on attendais tous, celle ou on peut parler d'informatique sans forcement tomber dans les clichés. Le site vulnhub propose un challenge autour du thème de cette série. En voici le writeup","date":"2024-02-09T00:00:00.000Z","image":"/medias/writeups/mr-robot/image.jpeg"},"headers":[],"relativePath":"writeups/vm-mr-robot.md","filePath":"writeups/vm-mr-robot.md"}`),i={name:"writeups/vm-mr-robot.md"};function t(l,s,o,r,c,u){return p(),a("div",null,s[0]||(s[0]=[e(`<p>La série Mr Robot est un peu comme la série que l&#39;on attendais tous, celle ou on peut parler d&#39;informatique sans forcement tomber dans les clichés. Le site vulnhub propose un challenge autour du thème de cette série.</p><p>Le fichier du challenge est téléchargeable ici. Le fichier .ova se monte tout seul dans virtual box, j&#39;ai volontairement modifié les paramètres réseaux, la VM n&#39;ayant pas besoin d&#39;accès internet. L&#39;objectif annoncé est de retouver les 3 parties du flag.</p><h2 id="reconnaissance" tabindex="-1">Reconnaissance <a class="header-anchor" href="#reconnaissance" aria-label="Permalink to &quot;Reconnaissance&quot;">​</a></h2><p>Commençons tout d&#39;abord par trouver l&#39;adresse ip de cette machine. Pour cela un simple ping sweep sur nmap suffit :</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>❯❯❯ nmap -sP 192.168.56.0/24</span></span>
